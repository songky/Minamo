...
(function($, undefined) {
	...
	// 默认参数
	$.Minamo.defaults   = {
		current		    : 0,	  // 定义图片从第几张开始
		autoplay	    : false,  // 定义是否自动播放，默认false
		interval	    : 2000,   // 定义自动播放的时间
		margintop       : '50px', // 定义图片上边距
		showlength      : 1,      // 定义显示的个数
        xoffsetshow     : '350',  // 定义当前显示图片的x轴位移
	...
	$.Minamo.prototype 	= {
		...
		_navigate			: function(dir) {
			...
			if(!this.supportTrans)
				this.$currentItm.addClass('wr-center');
		},
		// 开始轮播图片
